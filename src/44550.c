...
void func_80043950(void) {
    ...
    switch (D_80121B50) {
        case 0:
            addr = (u32) &D_EC9A0 - (u32) &D_E35C0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_E35C0, func_80043040(D_80112130[8]), addr);
        ...
        case 1:
            addr = (u32) &D_F6160 - (u32) &D_EC9A0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_EC9A0, func_80043040(D_80112130[8]), addr);
        ...
        case 2:
            addr = (u32) &D_FEDA0 - (u32) &D_F6160;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_F6160, func_80043040(D_80112130[8]), addr);
        ...
        case 3:
            addr = (u32) &D_10AAB0 - (u32) &D_FEDA0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_FEDA0, func_80043040(D_80112130[8]), addr);
        ...
        case 4:
            addr = (u32) &D_118670 - (u32) &D_10AAB0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_10AAB0, func_80043040(D_80112130[8]), addr);
        ...
        case 5:
            addr = (u32) &D_125C90 - (u32) &D_118670;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_118670, func_80043040(D_80112130[8]), addr);
        ...
        case 6:
            addr = (u32) &D_131A90 - (u32) &D_125C90;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_125C90, func_80043040(D_80112130[8]), addr);
        ...
        case 7:
            addr = (u32) &D_1384B0 - (u32) &D_131A90;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_131A90, func_80043040(D_80112130[8]), addr);
        ...
        case 8:
            addr = (u32) &D_13F3B0 - (u32) &D_1384B0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_1384B0, func_80043040(D_80112130[8]), addr);
        ...
        case 9:
            addr = (u32) &D_145380 - (u32) &D_13F3B0;
            D_80112130[8] = func_80042D58(addr);
            func_80043060(D_80112130[8]);
            func_80099C44(&D_13F3B0, func_80043040(D_80112130[8]), addr);
    ...
    addr = (u32) &D_14B450 - (u32) &D_147910;
    D_80112130[10] = func_80042D58(addr);
    func_80043060(D_80112130[10]);
    func_80099C44(&D_147910, func_80043040(D_80112144), addr);
